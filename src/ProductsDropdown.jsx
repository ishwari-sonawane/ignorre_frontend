    ...
    <div className="relative group w-full ">
      ...
      <div
        ...
        className={`cursor-pointer flex items-center w-full ${
          active === "Products" ? "text-[#4F45F7]" : "text-[#364153]"
        } hover:text-[#4F45F7]`}
      >
        <Link
          to="/product"
      ...
      >
        ...
        >
          ...
          <Link to="/" onClick={() => setIsProductOpen(false)}>
            <div className="flex gap-4 cursor-pointer hover:bg-[#e6eafa] hover:text-[#4F45F7] p-4 rounded-lg">
              <div className="bg-gray-100 text-[20px] p-3 flex items-center justify-center rounded-2xl">
                <GoGlobe />
              </div>
              <div>
        ...
        <div
          className={`${
            isMobile
              ? "hidden"
              : "w-[280px] bg-[#f3f4ff] rounded-xl p-6 flex flex-col justify-between"
          }`}
        >
          <div>
