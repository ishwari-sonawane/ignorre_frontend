  ...
  return (
    ...
    border border-gray-200">
      ...
      <div className="flex flex-col leading-tight">
        <p className="font-semibold text-[#252E3D] text-[14px]">Ignorre Agent</p>
        <p className="text-[12px] text-[#8B5CF6]">Available Now</p>
      </div>

      {/* Contact Button */}
     <a href="/contact">
       <button className="bg-[#1F2739] hover:bg-[#151B28] text-white text-[14px] px-5 py-3 rounded-full flex items-center gap-1">
        Contact
