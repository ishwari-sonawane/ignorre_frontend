...
const Product = () => {
  ...
  return (
    <>
      <ScrollToTop />
    <div className="bg-[#E3EAFF] min-h-screen font-sans selection:bg-purple-500/30">
      {/* Header Section */}
      <header className="pt-24 pb-16 px-6 text-center">
        <motion.span 
          initial={{ opacity: 0, y: 10 }}
          animate={{ opacity: 1, y: 0 }}
          className="text-[#312C85] font-semibold text-sm tracking-wider uppercase mb-4 block "
        >
          Products
        </motion.span>
        <motion.h1 
      ...
      <section className="border-t border-white/5 py-24 px-6 text-center">
        <h2 className="text-3xl md:text-4xl font-bold text-[#312C85] mb-4">Manage Everything From One Dashboard</h2>
