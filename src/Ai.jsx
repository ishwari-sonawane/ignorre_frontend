  ...
  <div className="max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8">
    ...
    {isMobile ? (
      ...
      <div className="slide-up flex flex-col items-center justify-center pt-16 pb-12">
        ...
        <div className="flex items-center text-sm font-medium text-gray-700 drop-shadow-md">
          <RiStarSFill />
          <RiStarSFill />
          <RiStarSFill />
          <RiStarSFill />
        ...
        {/* Headings */}
        <h1 className="text-[32px] font-semibold text-[#252E3D] leading-tight">
        ...
        <div className="flex flex-col gap-3 mt-4">
          <a href="/pricing">
            <button className="px-6 py-3 bg-[#5C60BF] text-white rounded-full font-semibold">
              Get Started Free
            </button>
          </a>
      ...
      <div className="slide-up flex flex-col md:flex-row items-center justify-center min-h-screen py-16">
        ...
        <div className="relative z-10 flex flex-col items-start justify-center w-full">
          ...
          <div className="flex items-center text-sm font-medium text-gray-700 drop-shadow-md mb-2">
            <RiStarSFill />
            <RiStarSFill />
            <RiStarSFill />
            <RiStarSFill />
          ...
          <h1 className="text-[45px] font-semibold text-[#252E3D]">
            The Unified AI Platform
          </h1>
          ...
          <div className="flex gap-3 mt-4">
            <a href="/pricing">
              <button className="px-6 py-3 bg-gradient-to-tr from-[#5C60BF] to-[#4671D7] text-white rounded-full font-semibold">
                Get Started Free
              </button>
            </a>
      ...
      <div className="slide-up flex flex-col lg:flex-row items-center justify-between min-h-screen py-16 pt-50">
        ...
        <div className="relative z-10 flex flex-col items-start justify-center w-full lg:w-[60%]">
          ...
          <div>
            <h1 className="text-[36px] sm:text-[48px] md:text-[60px] lg:text-[70px] text-[#312C85] font-semibold">
              The Unified AI Platform
            </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 mt-6">
            <div className="group inline-flex items-center gap-0">
              <a href="/pricing">
                <button className="text-white px-6 py-3 rounded-full font-semibold tracking-widest shadow-lg bg-gradient-to-tr from-[#5C60BF] to-[#4671D7]">
                  Get Started Free
                </button>
              </a>

              <button className="text-white p-3.5 rounded-full shadow-lg flex items-center justify-center bg-gradient-to-tr from-[#5C60BF] to-[#4671D7]">
                <MdOutlineArrowOutward size={20} />
              </button>
            </div>
    ...
    {isMobile ? (
      ...
      <div className="flex flex-col py-12">
        ...
        <div className="w-full">
          <div className="flex flex-row items-center gap-2 text-[#5B61C0] text-[16px] font-semibold">
            <IoSettingsOutline size={25} />
            <p>Features</p>
          </div>

          <div className="mt-6 text-[14px] text-[#252E3D]">
            <p>
        ...
        <div className="w-full mt-14">
          <div className="font-semibold text-[28px] text-[#312C85]">
            <h1>
            ...
            <div className="grid grid-cols-1 gap-6 mt-10">
              ...
              <div className="bg-white/10 rounded-lg p-3 mt-10 backdrop-blur-md shadow-[0_0_25px_rgba(0,0,0,0.3)]"
                ...
                <p className="text-[15px] text-[#252E3D]">Chat naturally with powerful AI models.</p>
              </div>
              ...
              <div className="bg-white/10 rounded-lg p-3 mt-10 backdrop-blur-md shadow-[0_0_25px_rgba(0,0,0,0.3)]"
                ...
                <p className="text-[15px] text-[#252E3D]">Compare models by quality, speed & cost.</p>
              </div>
              ...
              <div className="bg-white/10 rounded-lg p-3 mt-10 backdrop-blur-md shadow-[0_0_25px_rgba(0,0,0,0.3)]"
                ...
                <p className="text-[15px] text-[#252E3D]">Test prompts, tune models, experiment safely.</p>
              </div>
              ...
              <div className="bg-white/10 rounded-lg p-3 mt-10 backdrop-blur-md shadow-[0_0_25px_rgba(0,0,0,0.3)]"
                ...
                <p className="text-[15px] text-[#252E3D]">Real-time, web-aware search answers.</p>
              </div>
              ...
              <div className="bg-white/10 rounded-lg p-3 mt-10 backdrop-blur-md shadow-[0_0_25px_rgba(0,0,0,0.3)]"
                style={{ background: "radial-gradient(circle, rgba(195,210,255,0.9) 0%, rgba(245,245,255,1) 60%)" }}>
                <img src={cg} alt="" />
                <h1 className="text-[26px] font-semibold mb-5 mt-5 text-[#312C85]">AI Agents</h1>
                <p className="text-[15px] text-[#252E3D]">Autonomous agents to execute tasks.</p>
              </div>
                ...
                <div className="flex flex-col absolute bottom-7 right-2 gap-3 group cursor-pointer">
                  <a href="/feature">
                    <div className="flex items-center">
                      <p className="text-[18px] text-[#312C85] font-semibold">Explore More</p>
                      <MdOutlineArrowOutward size={20} className="ml-1 group-hover:rotate-45 transition-all text-[#312C85]" />
                    </div>
                  </a>
      ...
      <div className="flex flex-col xl:flex-row items-start justify-between min-h-screen py-16">
        ...
        <div className="slide-up w-full xl:w-[30%] flex flex-col justify-center">
          ...
          <div className="mt-12 text-[18px] text-[#252E3D]">
            <p>
              Experience how ignorre.ai brings together
              <br />
              conversational AI, real-time search, and
      ...
      {/* third page */}
         ...
         {isMobile ? (
        /* ------------------- 📱 MOBILE VIEW ------------------- */
        <div className="min-h-screen w-full bg-[#E3E9FF] Gfont px-4 abc">
          <div className="text-center max-w-5xl mx-auto">
            ...
            <div>
              <h1 className="text-[28px] font-semibold mb-5 text-[#312C85]">
                The Unified AI Platform Built for Modern Teams
              </h1>
              <p className="text-[14px] text-[#252E3D] px-2">
          ...
          <div className="w-full flex flex-col justify-center items-center gap-10">
            ...
            <div className="w-full flex flex-col lg:flex-row gap-5 mb-5">
              ...
              <div
                className="relative h-full w-full lg:w-70 rounded-2xl overflow-hidden p-5 bg-gradient-to-br from-[#4A56E2] via-[#4F6BE3] to-[#3E82EC]"
              >
            ...
            <div className="w-full flex flex-col lg:flex-row gap-5">
              <div
                className="relative h-full w-full lg:w-70 rounded-2xl overflow-hidden p-5 border border-gray-300 bg-white">
                {/* Content layer */}
                <div className="relative z-10 ">
                  <h1 className="text-[50px] text-[#312C85] font-bold">120+</h1>
                  <p className="text-[26px] text-[#312C85] font-semibold">Teams Onboarded</p>
              ...
              <div className="h-full w-full sm:w-165 border border-gray-300 rounded-2xl overflow-hidden relative bg-[#252E3D]">
                <h1 className="ml-6 mt-5 text-[50px] font-bold leading-tight text-white">50+</h1>
                <h3 className="ml-6 text-[26px] font-semibold text-white leading-tight">Long-Term Teams</h3>
            ...
            <div className="flex flex-col group cursor-pointer ml-0 lg:ml-185 mt-10 items-center md:items-start">
              <a href="/about">
                <div className="flex items-center">
                  <p className="text-[18px] text-[#312C85] font-sans font-semibold mb-2">
                    Get to Know More
                  </p>
                  {/* Arrow rotates on hover */}
                  <MdOutlineArrowOutward
              ...
              {/* Underline */}
              <div className="w-[165px] h-[1.5px] bg-[#312C85]"></div>
            </div>
        ...
        /* ------------------- 📲 TABLET VIEW ------------------- */
        <div className="min-h-screen w-full bg-[#E3E9FF] Gfont px-6 abc">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <h1 className="text-[34px] font-semibold mb-5 text-[#312C85]">
              The Unified AI Platform Built for Modern Teams
            </h1>
            <p className="text-[16px] text-[#252E3D]">
              ignorre.ai brings chat, real-time search, AI agents, model comparison, and OpenAI-compatible APIs into a<span className="hidden lg:inline"><br /></span> single, powerful platform—so teams can move faster and build smarter
            </p>
          </div>
        ...
        <div className="min-h-screen lg:h-320 w-full bg-[#E3E9FF] Gfont px-4 lg:px-0 abc">
          {/* ★ KEEP SLIDE UP ANIMATION ONLY ON DESKTOP */}
          <div className="slide-up text-center max-w-5xl mx-auto">
            <div className="text-[#5B61C0] pb-10 text-[18px] font-semibold">
              <p className="pt-30">
                <LuBrain size={25} className="block mx-auto lg:ml-95 -mb-7 mr-67" />
                Why Choose ignorre.ai
              </p>
            </div>
            <div>
              <h1 className="text-[28px] sm:text-[34px] md:text-[40px] lg:text-[44px] font-semibold mb-5 text-[#312C85]">
                The Unified AI Platform Built for Modern Teams
              </h1>
              <p className="text-[14px] sm:text-[16px] lg:text-[18px] text-[#252E3D] px-2">
                ignorre.ai brings chat, real-time search, AI agents, model comparison, and OpenAI-compatible APIs into a<span className="hidden lg:inline"><br /></span> single, powerful platform—so teams can move faster and build smarter
              </p>
            </div>
          </div>
          ...
          <div className="slide-up w-full flex flex-col lg:flex-row justify-center items-center gap-10 lg:gap-0">
            ...
            <div className="flex flex-col group cursor-pointer ml-0 lg:ml-185 mt-10 items-center md:items-start">
              <a href="/about">
                <div className="flex items-center text-[#312C85]">
                  <p className="text-[18px] text-[#312C85] font-sans font-semibold mb-2">
                    Get to Know More
                  </p>
                  {/* Arrow rotates on hover */}
                  <MdOutlineArrowOutward
                    size={20}
                    className="-mt-1 ml-1 transform transition-transform duration-300 group-hover:rotate-45 cursor-pointer"
                  />
                </div>
      ...
      <div className="bg-[#E3E9FF] Gfont abc pb-100 sm:pb-10">

      <div className="slide-up text-center">
        <div className="text-[#5B61C0] pb-5 text-[18px] font-semibold">
          <p className="pt-30">
            {/* <CiRoute size={25} className="block mx-auto lg:ml-215 -mb-7 mr-60" /> */}
            Our Process
          </p>
        </div>
        <h1 className="text-[26px] sm:text-[32px] lg:text-[44px] text-[#312C85] font-sans font-semibold mb-5 mt-5 abc">
          From Idea to AI in Production
        </h1>
        <p className="text-[#252E3D] text-[14px] sm:text-[16px] lg:text-[18px] font-sans px-3">
       ...
       <section
      ref={sectionRef}
      className="min-h-screen bg-[#E3E9FF] flex items-center justify-center px-4 md:px-8"
    >
      <div
        className="
          grid 
        ...
        {cardsData.map((card, i) => (
          ...
          >
            ...
            <div className="text-start text-black ml-3 mb-5">
              <div className="text-[50px] font-bold text-[#5A62C1]">{card.id}</div>
              <div className="text-[18px] opacity-80 text-[#312C85] font-bold">{card.desc}</div>
...
<div className="Gfont  w-full flex flex-col items-center -mt-30 bg-[#E3E9FF] px-4 sm:px-6 abc">
  {/* HEADER — SAME FOR ALL DEVICES */}
  <div className="slide-up text-center h-auto lg:h-80 w-full mt-5 px-2 abc md:pt-40">
    {/* <IoPricetagOutline size={18} className="mx-auto lg:ml-217 -mb-5 text-[#626EC7] transform scale-x-[-1]" /> */}
    <p className="text-[16px] sm:text-[18px] text-[#626EC7] font-semibold">Pricing Plans</p>
    <h1 className=" text-[26px] sm:text-[32px] lg:text-[44px] font-semibold mb-5 mt-4 text-[#312C85]">
      Choose the Right Plan for Your AI Journey
    </h1>
    <p className="text-[14px] sm:text-[16px] lg:text-[18px] text-[#252E3D]">
  ...
  <div className="w-full flex flex-col items-center mt-0 abc">
    <div className="flex items-center gap-2 border border-gray-300 rounded-full px-2 py-1 bg-white shadow-sm mt-16">
      <button
        onClick={() => setBillingCycle("monthly")}
        className={`px-5 py-2 rounded-full font-medium transition text-[18px] ${
          billingCycle === "monthly" ? "bg-[#312C85] text-white" : "text-gray-600"
        }`}
      >
        Monthly
      </button>
      ...
      <button
        ...
        className={`flex items-center gap-2 px-5 py-2 rounded-full font-medium transition text-[18px] ${
          billingCycle === "yearly" ? "bg-[#312C85] text-white" : "text-gray-600"
        }`}
      >
        Yearly
        {billingCycle === "yearly" && (
  ...
  {isMobile || isTablet ? (
    ...
    <div className="mt-10 flex flex-col gap-6 justify-center items-center abc">
      ...
      <div className="bg-white w-full max-w-sm rounded-2xl shadow p-7 border border-gray-200 lg:h-140">
       <p className="font-semibold text-[#312C85]">Starter</p>
              ...
              <p className="text-[15px] text-gray-700 mt-2 mb-4 Gfont">
                Perfect for individuals and small teams starting their journey with AI-powered productivity.
              </p>
              <a href="/contact">
                <button className="text-[18px] group flex items-center justify-center gap-2 w-full text-white py-3 rounded-full bg-[#252E3D] transition shadow">
                  Get Started Now
                  <MdOutlineArrowOutward size={18} className="transition-transform duration-300 group-hover:rotate-45" />
                </button>
              </a>

              <p className="mt-5 text-[15px] text-gray-700">Includes :</p>

              <ul className="mt-3 space-y-3 text-[15px] text-gray-700">
                <li className="flex gap-2"><FaCheckCircle className="text-[#312C85]" />Unlimited AI chat & search usage</li>
                <li className="flex gap-2"><FaCheckCircle className="text-[#312C85]" />Access to core AI tools and agents</li>
                <li className="flex gap-2"><FaCheckCircle className="text-[#312C85]" />Community & standard support</li>
                <li className="flex gap-2"><FaCheckCircle className="text-[#312C85]" />Regular feature updates</li>
                <li className="flex gap-2"><FaCheckCircle className="text-[#312C85]" />Secure cloud-based access</li>
              </ul>
      </div>
      ...
      <div className="bg-white w-full max-w-sm rounded-2xl shadow p-7 border border-gray-200 lg:h-140 ">
        <div className="flex items-center gap-2">
                ...
                <span className="text-[#4671D7] font-medium">Popular</span>
              </div>
              <div className="flex items-end gap-2 mt-2">
                <h1 className="text-[50px] font-bold bg-gradient-to-r from-[#5C60BF] to-[#4671D7] bg-clip-text text-transparent">
                  ${pricing2.pro}
                </h1>
                <p className="text-gray-500 mb-6">/ month</p>
              </div>
              ...
              <a href="/contact">
                <button className="group flex items-center justify-center gap-2 w-full text-white py-3 rounded-full bg-gradient-to-r from-[#5C60BF] to-[#4671D7] transition shadow">
                  Get Started Now
                  <MdOutlineArrowOutward size={18} className="transition-transform duration-300 group-hover:rotate-45" />
                </button>
              </a>
              ...
              <ul className="mt-3 space-y-3 text-[15px] text-gray-700">
                <li className="flex gap-2"><FaCheckCircle className="text-[#312C85]" /> Everything in Starter</li>
                <li className="flex gap-2"><FaCheckCircle className="text-[#312C85]" /> 3rd-party app integrations</li>
                <li className="flex gap-2"><FaCheckCircle className="text-[#312C85]" /> Advanced analytics & insights</li>
                <li className="flex gap-2"><FaCheckCircle className="text-[#312C85]" /> Team performance dashboard</li>
                <li className="flex gap-2"><FaCheckCircle className="text-[#312C85]" /> Priority support & enhanced security</li>
                <li className="flex gap-2"><FaCheckCircle className="text-[#312C85]" /> Detailed usage & activity reports</li>
              </ul>
      </div>
      ...
      <div className="bg-white w-full max-w-sm rounded-2xl shadow p-7 border border-gray-200">
       <p className="font-semibold text-[#312C85]">Enterprise</p>
              ...
              <a href="/contact">
                <button className="group flex items-center justify-center gap-2 w-full text-white py-3 rounded-full bg-[#312C85] transition shadow">
                  Get Started Now
                  <MdOutlineArrowOutward size={18} className="transition-transform duration-300 group-hover:rotate-45" />
                </button>
              </a>
              ...
              <ul className="mt-3 space-y-3 text-[15px] text-gray-700">
                <li className="flex gap-2"><FaCheckCircle className="text-[#312C85]" /> Dedicated account & success manager</li>
                <li className="flex gap-2"><FaCheckCircle className="text-[#312C85]" /> Custom dashboards & reports</li>
                <li className="flex gap-2"><FaCheckCircle className="text-[#312C85]" /> Full performance & feature access</li>
                <li className="flex gap-2"><FaCheckCircle className="text-[#312C85]" /> Enterprise onboarding & training</li>
                <li className="flex gap-2"><FaCheckCircle className="text-[#312C85]" /> API integrations & SLAs</li>
                <li className="flex gap-2"><FaCheckCircle className="text-[#312C85]" />AI model customization using your data</li>
                <li className="flex gap-2"><FaCheckCircle className="text-[#312C85]" />Advanced security & compliance support</li>
              </ul>
      </div>
    </div>
  ) : (
    ...
    <div className="mt-10 flex flex-col md:flex-row gap-6 justify-center items-center flex-wrap abc">
      ...
      <p className="font-semibold text-[#312C85]">Starter</p>
              ...
              <a href="/contact">
                <button className="text-[18px] group flex items-center justify-center gap-2 w-full text-white py-3 rounded-full bg-[#312C85] transition shadow">
                  Get Started Now
                  <MdOutlineArrowOutward size={18} className="transition-transform duration-300 group-hover:rotate-45" />
                </button>
              </a>
              ...
              <ul className="mt-3 space-y-3 text-[15px] text-gray-700">
                ...
                <li className="flex gap-2"><FaCheckCircle className="text-[#312C85]" />Access to core AI tools and agents</li>
                <li className="flex gap-2"><FaCheckCircle className="text-[#312C85]" />Community & standard support</li>
                <li className="flex gap-2"><FaCheckCircle className="text-[#312C85v]" />Regular feature updates</li>
                <li className="flex gap-2"><FaCheckCircle className="text-[#312C85]" />Secure cloud-based access</li>
              </ul>
      </div>
  ...
  >
    ...
    >
      ...
      <h1 className="text-[32px] sm:text-[38px] lg:text-[44px] font-semibold text-[#312C85] text-center xl:text-left">
        Answers to Common
        <br className="lg:hidden" />
        Questions
      </h1>

      <p className="text-[16px] sm:text-[18px] text-[#252E3D] text-center xl:text-left">
        ...
        <div className="text-white p-5">
          ...
          <a href="/contact">
            <div className="flex items-center mt-5">
              ...
              <MdOutlineArrowOutward
                size={20}
                className="ml-1 transform transition-transform duration-300 group-hover:rotate-45 cursor-pointer"
              />
            </div>
          </a>
    ...
    >
      {faqs.map((faq, index) => (
        <div
          key={index}
          className="border border-gray-300 rounded-2xl mb-4 overflow-hidden shadow-sm"
        >
          <button
            className="w-full text-left p-5 bg-white flex justify-between items-center"
            onClick={() => toggleFAQ(index)}
          >
            <span className="text-[16px] sm:text-lg text-[#252E3D]">
              {faq.question}
            </span>

            <span className="text-[#312C85] text-2xl font-bold">
              {openIndex === index ? "-" : "+"}
            </span>
          </button>
          ...
          {/* Answer Section */}
          {openIndex === index && (
            <div className="p-5 bg-white text-gray-500 text-base transition-all duration-300">
              {faq.answer}
            </div>
          )}
        </div>
...
{/* ninth page */}
  ...
  <div className="max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8">
    ...
    >
      {/* Left Small Heading */}
      <div className="flex items-center gap-3 text-[#5B62C0] text-[16px] sm:text-[18px] font-semibold mt-5">
        <FaEye />
      ...
      <div className="mt-6 lg:mt-0 lg:max-w-[850px]">
        <h1 className="text-[30px] sm:text-[38px] lg:text-[44px] font-semibold text-[#312C85]">
          Discover the Future of AI in Business
        </h1>

        <p className="text-[15px] sm:text-[16px] lg:text-[18px] text-[#252E3D] mt-3">
    ...
    {isDesktop ? (
      ...
      <div className="slide-up flex flex-col xl:flex-row justify-center items-center gap-6 mt-10">
        ...
        <div className="w-full xl:w-[700px] flex flex-col sm:flex-row gap-5">
          ...
          {/* CARD 1 */}
          <div className="flex-1 p-5 group rounded-2xl border border-gray-300 bg-white">
            <img
              src={man}
              alt=""
              className="transition-transform duration-700 ease-in-out group-hover:scale-110 rounded-2xl"
            />

            <p className="text-[12px] mt-6">July 27, 2025</p>

            <h1 className="text-[15px] font-semibold text-[#312C85]">
      ...
      <div className="slide-up flex flex-col justify-center items-center gap-6 mt-10">
        ...
        <div className="flex flex-col lg:flex-row w-full max-w-[900px] gap-5">
          ...
          <div className="rounded-2xl border border-gray-300 p-5 bg-white flex-1">
    ...
    {/* BUTTON */}
    <a href="#">
      <div className="flex items-center justify-center group mt-10 text-[#312C85]">
    ...
    <div className="w-[130px] h-[1.5px] bg-[#312C85] mx-auto mt-3 mb-10"></div>
      ...
      <div className="min-h-screen lg:min-h-0 xl:-mt-15 lg:mt-0 Gfont lg:mb-0 bg-[#E3E9FF] abc">
        ...
        mx-auto my-20 lg:my-0">
              ...
              <h5 className="text-[14px] lg:text-[15px] font-semibold mt-4 lg:mt-5 text-[#312C85]">Anup Gosavi</h5>
              <p className="text-[14px] lg:text-[15px] text-[#4A5565]">Founder & CEO of Vayuna Voicetech Pvt Ltd</p>
              <div className="flex flex-col lg:flex-row mt-5 lg:mt-10 gap-4 lg:gap-4">
                <div className="group inline-flex items-center gap-0 self-center lg:self-auto">
                 ...
                 <a href="/contact">
                  <button
                    className="text-white px-6 py-3 text-[16px] lg:text-[18px] rounded-full font-semibold font-sans tracking-widest shadow-lg transition-all duration-500 bg-gradient-to-tr from-[#5C60BF] to-[#4671D7]">
                    Get Started Now
                  </button>
                 </a>
                  ...
                  {/* Arrow Button */}
                  <button
                    className="text-white p-3 lg:p-3.5 rounded-full shadow-lg flex items-center justify-center transition-all duration-500 bg-gradient-to-tr from-[#5C60BF] to-[#4671D7] group-hover:from-[#333] group-hover:to-[#333]">
                    <MdOutlineArrowOutward
                      size={20}
               ...
               <a href="/contact">
                <button className="group flex items-center gap-2 text-[16px] lg:text-[18px] text-[#312C85] px-6 py-3 font-sans rounded-full font-semibold tracking-widest shadow-lg transition-all duration-500 bg-white hover:bg-gray-700 hover:text-white hover:border-none self-center lg:self-auto">
                  Talk to Us
                  <MdOutlineArrowOutward
                    size={20}
