...
const faqs = [
  ...
  <div className="slide-up min-h-[85vh] max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center justify-between">
    ...
    <div className="w-full lg:w-1/2 flex flex-col justify-center">
      ...
      <div className="flex flex-col gap-4 mt-10 lg:mt-20 xl:mt-28 2xl:mt-36">
        <h1 className="text-[32px] sm:text-[40px] lg:text-[48px] 2xl:text-[54px] leading-tight text-[#312C85] font-bold">
          Powering secure, lightning-fast
          <br className="hidden lg:block xl:hidden" />
          internet infrastructure
        </h1>

        <p className="text-[14px] sm:text-[16px] text-[#4A5579] font-semibold">
  ...
  >
    {/* HEADING */}
    <div>
      <p className="text-[16px] text-[#4A5579] font-semibold">
        FEATURES EXPLORED
      </p>
  ...
  >
    ...
    >
      ...
      <p className="text-[14px] sm:text-[18px] text-[#585757]">
   ...
   <div className="bg-[#E1E8FF] overflow-x-hidden">
  <div
    className="
      slide-up
      min-h-[80vh]
  ...
  >
    ...
    <div className="w-full lg:w-1/2 flex flex-col justify-center">
      ...
      >
        ...
        <p className="text-[14px] sm:text-[16px] text-[#585757]">
      ...
      >
        <div className="flex gap-2">
          <img
            src={c1}
            alt=""
            className="bg-[#E2DDFD] rounded-xl p-1"
          />
    ...
    >
      ...
      >
        <div className="w-full sm:flex-1 p-6 lg:p-8">
          ...
          <p className="text-[14px] text-[#585757]">
            Florida, US
          </p>
        </div>
  ...
  >
    ...
    >
      ...
      >
        ...
        <p className="mt-6 mb-2 text-[14px] text-[#585757] font-semibold">
        ...
        <p className="text-[14px] lg:text-[16px] mt-6 flex items-center gap-1 text-[#585757] font-semibold">
          Read Article
          <RiArrowRightUpLine
            size={18}
