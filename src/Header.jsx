...
const Header = () => {
    ...
    return (
        <nav className="w-full bg-white border-b border-gray-200 abc sticky top-0 z-50">
                            ...
                            <div className="grid grid-cols-3 gap-6 h-full">
                              ...
                              <div className="col-span-2 grid grid-cols-2 gap-6 content-start">
                                 ...
                                 <div className="flex gap-4 cursor-pointer hover:bg-[#e6eafa] hover:text-[#4F45F7] p-4 rounded-lg">
                                    <div className='bg-gray-100 text-[20px] p-3 text-center flex items-center justify-center rounded-2xl hover:text-white'>
                                        <GoGlobe />
                                    </div>
                                    <div>
...
>
  ...
  className={`cursor-pointer flex items-center gap-1 ${
    active === "pricing" ? "text-[#4F45F7]" : "text-[#364153]"
  } hover:text-[#4F45F7]`}
>
  Pricing
</Link>
...
<Link
  ...
  className={`cursor-pointer flex items-center gap-1 ${
    active === "testimonial" ? "text-[#4F45F7]" : "text-[#364153]"
  } hover:text-[#4F45F7]`}
>
  Testimonial
</Link>
...
<Link
  ...
  className={`cursor-pointer flex items-center gap-1 ${
    active === "faq" ? "text-[#4F45F7]" : "text-[#364153]"
  } hover:text-[#4F45F7]`}
>
  FAQ
</Link>
...
<Link
  ...
  className={`cursor-pointer flex items-center gap-1 ${
    active === "contact" ? "text-[#4F45F7]" : "text-[#364153]"
  } hover:text-[#4F45F7]`}
>
  Contact
</Link>
                    ...
                    <div className="lg:hidden w-full pt-4">
                        <button className=" bg-black text-white px-5 py-3 rounded-full text-sm font-medium hover:bg-gray-900 transition">
                            Get Started
                        </button>
                    </div>
                </div>
                ...
                <div className="hidden lg:block">
                    <button className="bg-black text-white px-6 py-3 rounded-full text-sm font-medium hover:bg-gray-900 transition">
                        Get Started
                    </button>
                </div>
